...
# Your code here
best_product = sales_df.loc[sales_df['Total_Sales'].idxmax(), 'Product']
...
print("1. Prioritize marketing the higher performing categories in each region.")
print("2. Offer more promotions for products that have higher average sales when discounted.")
print("3. Increase inventory of high revenue and in demand products such as PhoneX and LaptopPro.")